...
// En entornos de producción, es más seguro usar rutas absolutas para las imágenes
// ubicadas en el directorio 'public'.
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gray-100 font-sans">
      ...
      <div className="flex flex-col items-center gap-4 p-8 bg-white rounded-xl shadow-lg mb-8 max-w-lg w-full">
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 text-center">Bienvenido</h1>
        <img 
          src="/odiseapp.png" 
          alt="Logo de Odisea" 
