...
  };
  ...
  // NUEVA FUNCIÓN: Maneja la cancelación (cierra la WebApp)
...
      // Configurar botón principal (Crear Operación)
      tg.MainButton.setText("✅ Crear Operación");
...
      // Configurar botón de regreso (Cancelar)
      tg.BackButton.show();
      
...
      // El Botón de Regreso de Telegram llama a handleCancelCreation
...
        </div>
        ...
        {/* --- BOTONES DE ACCIÓN (Opcional, ya que Telegram MainButton ya existe) --- */}
        {/* Se añaden para una mejor experiencia de usuario en entornos sin Telegram WebApp o como redundancia/claridad */}
        <div style={{
            display: 'flex',
            gap: '10px',
            marginTop: '20px',
            marginBottom: '40px' // Espacio para el MainButton de Telegram
        }}>
            {/* Botón Cancelar */}
            <button
                type="button"
                ...
                style={{
                    ...
                    // Estilo de botón secundario/cancelar
                    backgroundColor: 'var(--tg-theme-secondary-bg-color, #e5e5e5)',
                    color: 'var(--tg-theme-text-color, #000000)',
                    border: '1px solid var(--tg-theme-hint-color, #999999)',
            ...
            {/* Botón Crear Operación (Usando el handler ya definido) */}
            <button
                type="button"
                onClick={handleCreateOperacion}
                ...
                style={{
                    ...
                    // Estilo de botón principal/crear
                    backgroundColor: 'var(--tg-theme-button-color, #0088cc)',
                    color: 'var(--tg-theme-button-text-color, #ffffff)',
                    border: 'none',
                    opacity: isProcessing || loading ? 0.6 : 1,
                }}
            >
                {isProcessing ? '⏳ Creando...' : '✅ Crear Operación'}
            </button>
        </div>
        {/* --- FIN BOTONES DE ACCIÓN --- */}

        {/* Espacio adicional para el botón de Telegram (Se reduce el espacio si añadimos botones internos) */}
