...
Revision ID: 5be21d8f4a97
Revises: a237e026be28
Create Date: 2025-08-28 21:30:58.502005
...
revision: str = '5be21d8f4a97'
down_revision: Union[str, None] = 'a237e026be28'
...
def upgrade() -> None:
    ...
    op.execute(
        ...
        UPDATE task_list
        SET task_key = CASE 
            WHEN task_type = 'vineyard' THEN 'V' || id::TEXT
            WHEN task_type = 'winery' THEN 'W' || id::TEXT
            ELSE 'Z' || id::TEXT
        END
        """
    )
